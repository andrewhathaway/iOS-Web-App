...
Here we need to setup a few things for you application. App viewport, a specific tag that is iPhone 5 friendly as people have found issues with other versions of this tag. Fullscreen your app, removes navigation bars ETC and finally, the App Title.
